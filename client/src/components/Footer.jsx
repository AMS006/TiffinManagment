  ...
  return (
    <>
      ...
      <div className="naem order-1 pt-5 md:pl-7 lg:flex flex-col items-center ">
        <h1 className='font-bold text-5xl text-slate-900 md:text-4xl md:pt-1'>Name</h1>
      ...
      <ul className='flex flex-col'>
        ...
        <li className='px-2 py-3 flex gap-2 items-center text-gray-900 text-lg cursor-pointer'><BsFacebook color="primary"/> <BsInstagram sx={{color:"pink[500]"}}/> <BsTwitter color="primary"/></li>
      </ul>
      </div>
