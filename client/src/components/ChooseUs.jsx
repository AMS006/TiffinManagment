...
function ChooseUs() {
  return (
    ...
    <div className="card grid grid-cols-1 my-5 mx-4  sm:grid-cols-1 sm:grid lg:grid lg:grid-cols-2 " >
  <div className='border-2 border-gray-600 rounded-md sm:grid sm:grid-cols-2 my-3  sm:my-3 lg:my-1'>
  <img src={img1} alt="image1" className='w-auto order-1'/>
  ...
  <img src={img2} alt="image1" className='w-auto sm:order-2 lg:order-1'/>
  ...
  <img src={img3} alt="image1" className='w-auto md:order-1 lg:order-2'/>
