...
function Info() {
  ...
  return (
    <div className='flex sm:flex-row flex-col md:gap-6 gap-2 lg:px-12 md:px-8  px-2 my-8'>
      <div className='sm:w-2/5 w-full rounded overflow-hidden'>
        <img src="https://i.pinimg.com/originals/13/40/bb/1340bb8d2ea075701889cbcecbac9c13.jpg" className='w-full h-full' alt="Info" />
      </div>
      <div className='sm:w-3/5 w-full flex flex-col gap-4 items-center justify-center'>
        ...
        <button className='md:w-2/3 px-2 bg-slate-900 rounded-md text-white py-2 md:text-lg md:font-semibold' onClick={() => navigate("/providers")}>Book Your Tiffin</button>
      </div>
    </div>
  )
}
